...
with open("Zadanie 2\\Nomer 4\\products_82.pkl", "rb") as f:
    products = pickle.load(f)

#print(products)
# cчитаем данные об обновлении цен
with open("Zadanie 2\\Nomer 4\\price_info_82.json") as f:
...
with open("Zadanie 2\\Nomer 4\\products_itog_82.pkl", "wb") as f:
